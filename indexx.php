...
<body id="cuerpo" onload="ocultar()">
	<div class="animated fadeIn fuente">	
		...
		<nav class="navbar navbar-light">
				...
				<li class="nav-item dropdown listanav">
					<div class="nav-link dropdown-toggle" id="midropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Productos </div>
					    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
						    <li><a class="nav-link dropdown-item dropdounColores" href="#"> GalMus Software </a></li>
				...
				<a class="nav-link" href="acerca.html#contact"> Contacto </a>
		...
		<aside id="barraPromo" style="display: none;">
			<span id="bpartePromo_1">
				<a class="nav-link" href="#div-promociones" onclick="mostrar()" ><i class="fas fa-certificate" onclick="mostrar()" href="#div-promociones" ></i> Mis promociones </a>
			</span>
			<span id="bpartePromo_2">
	    	...
	    	<div id="id01" class="w3-modal">
		     	<div class="w3-modal-content modal-lg w3-animate-zoom">
		      		<header class="w3-container w3-black"> 
		       			<span onclick="document.getElementById('id01').style.display='none'" class="w3-button w3-black w3-hover-aqua w3-large w3-display-topright">&times;
		       			</span>
		       			<h2>Bienvenido</h2>
		    		</header>
				    ...
				    <div id="registrarse" class="container opcion"><br>
					    ...
					    <div id="formNormales" class="container-fluid animated zoomInUp">
						 	<form id="fusua" method="POST" action="scripts/php/registro_usergeneral.php" class="container-fluid">
						 		<div class="row align-items-center justify-content-center">
								    <label class="control-label col-xs-12">
								    	<strong>Nombre(s):</strong>
								    	<span class="req">*</span>
								    </label>
								 	<input title="Se necesita su Nombre" type="text" required minlenght="1" class="ent-modal estilosinputs form-control" maxlength="30" placeholder=" Nombre" name="nombres"><br>

								    <label class="control-label col-xs-12">
								    	<strong>Apellido Paterno:</strong>
								    	<span class="req">*</span>
								    </label>
								    <input title="Se necesita su Apellido Parteno" type="text" required minlenght="5" maxlength="50" class="ent-modal estilosinputs form-control" placeholder=" Paterno" name="apellidopat"><br>

								    <label class="control-label col-xs-12">
								    	<strong>Apellido Materno:</strong>
								    	<span class="req">*</span>
								    </label>
								    <input title="Se necesita su Apellido Materno" type="text" required minlenght="5" maxlength="50" class="ent-modal estilosinputs form-control" placeholder=" Materno" name="apellidomat"><br>

								    <label class="control-label col-xs-12">
								    	<strong>Correo Electronico:</strong>
								    	<span class="req">*</span>
								    </label>
								 	<input title="Se necesita su Correo Electronico" required class="ent-modal estilosinputs form-control" type="email" minlenght="1" maxlength="30" id="inputEmail" placeholder=" Correo Electronico" name="correo"><br>

								 	<label class="control-label col-xs-12">
								 		<strong>Contraseña:</strong>
								 		<span class="req">*</span>
								 	</label>
								 	<input title="Se necesita su Contrasena" required type="password" minlenght="8" maxlength="16" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{3,}" class="ent-modal estilosinputs" id="inputPassword" placeholder=" Contraseña"><br>

								    <label class="control-label col-xs-12">
								    	<strong>Confirmar Contraseña:</strong>
								    	<span class="req">*</span>
								    </label>
		            				<input type="password" required minlenght="8" maxlength="16" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{3,}" class="ent-modal estilosinputs" placeholder=" Confirmar Contraseña" name="contrasena"><br>
								    ...
								    <input type="number" required minlenght="8" maxlength="10" pattern="\([0-9]{3}\) [0-9]{3}[ -][0-9]{4}" class="ent-modal estilosinputs" placeholder=" Telefono" name="tel"><br>
									...
									<select type="text" required class="ent-modal estilosinputs form-control" placeholder=" Ocupación " style="height: 45px;" id="listaOpcion">
									</select><br>

								   <label class="control-label col-xs-12">
								    	<strong>Edad:</strong>
								    </label>
								    <input type="number" required minlenght="2" maxlength="3" pattern="\([0-9]{3}\) [0-9]{3}[ -][0-9]{4}" class="ent-modal estilosinputs" placeholder=" Edad" name="edad"><br><br>

								    <label class="checkbox-inline radio-opciones">
								        <input type="checkbox" value="agree">  Acepto 
									...
									<footer class="container">
										<div class="w3-container w3-light-grey w3-padding">
					        				...
					        				<button class="w3-button w3-right w3-white w3-border" onclick="document.getElementById('id01').style.display='none'">Cerrar</button>
					    				</div>
									</footer>
							    </div>
						    </form>
		...
		<br>
		<main>
		    <!--a href="scripts/php/prueba.php" class="text-center"> Ver bd </a-->
					...
					<div id="Diapos" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="carousel-item active">
								<img src="imagenes\LandingPage\1920x1080_1.jpg" class="d-block img-fluid" alt="imagen 1">
								<div class="carousel-caption d-none d-md-block">
									<h3>Este es el Nuevo Slide 1</h3>
									<p> Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
								</div>
							</div>
							
							<div class="carousel-item">
								<img src="imagenes\LandingPage\1920x1080_2.jpg" class="d-block img-fluid" alt="imagen 2">
								<div class="carousel-caption d-none d-md-block">
									<h3>Este es el Nuevo Slide 2</h3>
									<p> Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
								</div>
							</div>

							<div class="carousel-item">
								<img src="imagenes\LandingPage\1920x1080_3.jpg" class="d-block img-fluid" alt="imagen 3">
								<div class="carousel-caption d-none d-md-block">
									<h3>Este es el Nuevo Slide 3</h3>
									<p> Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
								</div>
							</div>
						</div>
			...
			<article class="container-fluid">
				<hr><br>
				<p class="animated infinite pulse" id="temaprinci">La música es un idioma y aquí aprenderás a leerlo.</p>
			</article>
			...
			<div class="container">
				...
				<section class="row align-items-center justify-content-center">	
					...
					<aside class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
						<div class="container-fluid"><img src="imagenes/LandingPage/partituras.svg" class="img-fluid imgnota" alt="partituras"></div>
						<p class="notaspar"><br>La MÚSICA es la medida métrica en subdivisión, aparte el arte de combinar y ordenar sonidos y silencios en el tiempo, de manera ordenada y estética.</p>
					</aside>
				</section>
			</div>
			...
			<div class="container-fluid">
				<hr><br>
				<p id="temaprinci">Curso práctico para aprender a leer música (Solfeo)</p>
				<div class="container">
					<section class="row align-items-center justify-content-center">	
						<article class="col-xs-12 col-sm-8 col-md-9 col-lg-9"><br>
								<h2 class="text-center"> ¿Software en Desarrollo? </h2><br>
								<p class="notaspar">Debido a la gran necesidad por parte de los profesores de música a innovar su método de enseñanza en la parte de notas musicales con el método de George Dandelot el cual se basa en su manual con el nombre ‘Estudio de las claves Sol’ Fa y Do’ se tiene la necesidad de crear un sistema que ayude a la enseñanza de notas musicales.</p>
								<div class="container-fluid">
        	...
        	<div class="container-fluid " id="div-promociones" >
				...
				<div class="foo">
						 ...
						 <span class="letter" data-letter="E" onclick="ocultar()">E</span>
 						 <span class="letter" data-letter="S" onclick="ocultar()">S</span>
 						<hr>
				</div>
				<!--efecto promociones-->
				<div class="container">
					<section class="row align-items-center justify-content-center">	
						<div class="color-xs-12 col-sm-6 col-md-3 promociones">
							...
							<p class="nombresdeve anim-subrayado_piepa sombraPromo ">NotApp "Notas Musicales"</p>
							<img src="imagenes/acercaDeOrg/nt.svg" alt="NotApp" height="185px;" width="245px; " class="icoFacebook">
			         ...
			         <h4 class="text-center anim-subrayado_piepa" style="padding-top: 20px;">Ubicación</h4>
			          <address>
						<ul class="list-unstyled">
							...
							<div class="row align-items-center justify-content-center">
								<a class="btn btn-warning" href="acerca.html#map" target="_blank" role="button"><strong>Ver ubicación</strong></a>
							</div>
						</ul>
					 </address>
			        </div>
			      ...
			      <div class="color-xs-12 col-sm-6 col-md-3">
			        ...
			        <div class="piedepag2">
			          ...
			          <ul class="list-unstyled">
			            ...
			            <li>Pedro Erick Ríos García</li>
			            <li>Víctor Martínez Martínez</li>
			            <li>Alejandro Medina Alcántara</li>
			          </ul>
			        </div>
			      </div>
			    </div>
